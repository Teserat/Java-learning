...
public class FirstList {
    public static void main(String[] args) {
        ...
        ExtraMethods.linia("Usuniecie pierwszej i 4 osoby ORAZ osoby o imieniu :" + wygenerowaneOsoby.get(wygenerowaneOsoby.size() - 1).imie);
        wygenerowaneOsoby.remove(wygenerowaneOsoby.size() - 1); //remove też możliwe do użycia
        wygenerowaneOsoby.removeFirst();
        wygenerowaneOsoby.remove(2); // 2 osoba bo zaczynamy liczyć od zera oraz już jedną osobę usuneliśmy
        ...
        ExtraMethods.linia("zmiana imienia i nazwska osoby z numerem indexu 1 (czyli poz. 2) na xxx");
        wygenerowaneOsoby.get(1).imie = "xxx";
        wygenerowaneOsoby.get(1).nazwisko = "xxx";
        ...
        //wygenerowaneOsoby.clear(); //czyszczenie listy
    }
}
